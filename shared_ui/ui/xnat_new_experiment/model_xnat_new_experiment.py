class ModelXnatNewExperiment:
    ...
    @staticmethod
    def can_submit(parent_project: str, subject_project: str,
                   experiment_name: str, experiment_id: str) -> bool:
        return bool((parent_project or "").strip()) and bool((subject_project or "").strip()) and bool((experiment_name or "").strip()) and bool((experiment_id or "").strip())
