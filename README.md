...
🔗 **Event page:** https://www.eurobioimaging.eu/events/image-data-community-days-2026/
...
- **Material (.pptx):**  
  [Download material](https://raw.githubusercontent.com/cim-unito/XNAT-PIC/master/ImageDataCommunityDays2026/UserMaterial/ImageDataCommunityDays2026_FG.pptx)

- **Example Bruker raw data (.zip):**  
...
- **Example DICOM data (.zip):**  
  [Downoload example DICOM data](https://github.com/cim-unito/XNAT-PIC/releases/download/v2.1-beta.1/Project1_BLEP.zip)
...
## Releases
You can download XNAT-PIC from the GitHub Releases page:

- **Direct MSI download (Windows):** [XNAT-PIC-2-1-0-beta-1.msi](https://github.com/cim-unito/XNAT-PIC/releases/download/v2.1-beta.1/XNAT-PIC-2-1-0-beta-1.msi)
